...
@Component({
  ...
  template: `
    <div class="page-header flex-between">
      <div>
        <h1>Productos</h1>
        <p>Gestión de productos — acceso controlado por atributos (ABAC)</p>
      </div>
      @if (canInsert()) {
    ...
    <div class="card" style="margin-top:20px;border-color:var(--border-hi)">
      <p style="font-size:11px;color:var(--text-muted);margin-bottom:10px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase">Tus permisos ABAC activos</p>
